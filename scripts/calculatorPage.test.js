...
const calculateValidatedAffordability =
  methodsToTest.calculateValidatedAffordability;
...
describe("Testing calculatorPage functionality", () => {
  test("Testing affordability and spending difference values are calculating the correct values", () => {
    ...
    const expectedTotalAffordability =
      totalIncomeTest - (totalHouseholdTest + totalAdditionalTest);
    const expectedTotalDifference =
      expectedTotalAffordability - totalGamblingTest;
  ...
  test("Testing total income value is the calculation of the correct values", () => {
    ...
    const savingsTest = 5;
    const expectedTotal =
      salaryTest + bonusTest + otherTest - (pensionTest + savingsTest);
